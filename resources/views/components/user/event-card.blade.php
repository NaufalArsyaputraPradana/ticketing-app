...
<a href="{{ $href ?? '#' }}" class="block group">
    <div class="card bg-white h-full shadow-md hover:shadow-xl transition-all duration-300 border border-gray-200 hover:border-primary {{ ($isExpired || $isOutOfStock) ? 'opacity-60' : '' }}">
