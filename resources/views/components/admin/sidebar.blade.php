<div class="drawer-side is-drawer-close:overflow-visible z-50">
    ...
    <div class="flex min-h-full flex-col items-start bg-gradient-to-br from-teal-600 via-cyan-600 to-blue-700 text-white w-72 is-drawer-close:w-20 is-drawer-open:w-72 shadow-2xl backdrop-blur-sm relative overflow-hidden">
                   ...
                   data-tip="Dashboard">
                    <div class="flex items-center gap-3 w-full">
                        <div class="relative flex-shrink-0">
                            <div class="absolute inset-0 bg-white/20 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div class="relative p-2 bg-white/10 rounded-lg {{ request()->routeIs('admin.dashboard') ? 'bg-white/20' : '' }}">
                    ...
                    @if(request()->routeIs('admin.dashboard'))
                        <div class="absolute right-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-white rounded-l-full shadow-lg shadow-white/50"></div>
                    @endif
                </a>
            </li>
                ...
                <a href="{{ route('admin.categories.index') }}" 
                   ...
                   data-tip="Kategori">
                    <div class="flex items-center gap-3 w-full">
                        <div class="relative flex-shrink-0">
                            <div class="absolute inset-0 bg-white/20 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div class="relative p-2 bg-white/10 rounded-lg {{ request()->routeIs('admin.categories.*') ? 'bg-white/20' : '' }}">
                ...
                <a href="{{ route('admin.events.index') }}" 
                   ...
                   data-tip="Event">
                    <div class="flex items-center gap-3 w-full">
                        <div class="relative flex-shrink-0">
                            <div class="absolute inset-0 bg-white/20 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div class="relative p-2 bg-white/10 rounded-lg {{ request()->routeIs('admin.events.*') ? 'bg-white/20' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                ...
                <a href="{{ route('admin.histories.index') }}" 
                   ...
                   data-tip="History">
                    <div class="flex items-center gap-3 w-full">
                        <div class="relative flex-shrink-0">
                            <div class="absolute inset-0 bg-white/20 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity"></div>
                            <div class="relative p-2 bg-white/10 rounded-lg {{ request()->routeIs('admin.histories.*') ? 'bg-white/20' : '' }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="relative w-full p-4 border-t border-white/20 backdrop-blur-sm bg-white/5">
            ...
            <div class="is-drawer-close:hidden mb-3 p-3 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20">
                <div class="flex items-center gap-3">
                    <div class="relative">
                        <div class="absolute inset-0 bg-gradient-to-br from-teal-400 to-blue-500 rounded-full blur-md opacity-50"></div>
                        <div class="relative w-10 h-10 bg-gradient-to-br from-teal-500 to-blue-600 rounded-full flex items-center justify-center ring-2 ring-white/30 shadow-lg">
            ...
            <form action="{{ route('logout') }}" method="POST">
                ...
                <button type="submit" 
                    ...
                    <div class="relative flex items-center gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="group-hover:rotate-12 transition-transform duration-300">
