    ...
    <div class="navbar-end gap-2">
        ...
        <div class="dropdown dropdown-end">
            <label tabindex="0" class="btn btn-ghost btn-circle avatar">
                <div
                    class="w-10 rounded-full bg-gradient-to-br from-blue-900 to-blue-700 flex items-center justify-center shadow-md">
                    <span class="text-lg font-semibold">{{ substr(Auth::user()->name, 0, 1) }}</span>
                </div>
            </label>
            <ul tabindex="0"
                class="mt-3 z-[1] p-2 shadow-lg menu menu-sm dropdown-content bg-white rounded-box w-60 border border-gray-200">
                ...
                <li>
                    <a href="{{ route('home') }}"
                        class="flex items-center gap-3 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-900">
