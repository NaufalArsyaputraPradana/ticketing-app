<x-layouts.admin title="Manajemen Tipe Tiket">
    <div class="container mx-auto p-6 lg:p-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-800">Manajemen Tipe Tiket</h1>
                <p class="text-sm text-gray-500 mt-1">Kelola tipe tiket anda</p>
            </div>
        ...
        <div class="overflow-x-auto rounded-xl bg-white shadow-lg">
            <div class="p-6 border-b border-gray-100">
                <h2 class="font-semibold text-gray-700">Daftar Tipe Tiket</h2>
            </div>
                            ...
                            <td>
                                <div class="flex gap-2 justify-center">
                                    <button class="btn btn-sm btn-info gap-1" 
                                            onclick="openEditModal({{ $ticketType->id }}, '{{ $ticketType->name }}')">
                                    ...
                                    <button class="btn btn-sm btn-error gap-1" 
                                            onclick="openDeleteModal({{ $ticketType->id }}, '{{ $ticketType->name }}')">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr>
                            <td colspan="3" class="text-center py-8">
                                <div class="text-gray-400">
                                    ...
                                    <p class="font-medium">Tidak ada tipe tiket tersedia</p>
                                    <p class="text-sm mt-1">Klik "Tambah Tipe Tiket" untuk membuat tipe tiket baru</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="modal-box max-w-md border-2 border-gray-200 shadow-xl">
            <form method="POST" action="{{ route('admin.ticket-types.store') }}">
                ...
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-800">Tambah Tipe Tiket</h3>
                    <p class="text-sm text-gray-500 mt-2">Masukkan informasi tipe tiket baru</p>
                </div>
                ...
                <div class="form-control w-full mb-8">
                    ...
                    <input type="text" 
                           placeholder="Contoh: VIP, Reguler, Ekonomi" 
    ...
    <dialog id="edit_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box max-w-md border-2 border-gray-200 shadow-xl">
            <form method="POST" id="edit_form">
                ...
                @method('PUT')
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-800">Edit Tipe Tiket</h3>
                    <p class="text-sm text-gray-500 mt-2">Perbarui informasi tipe tiket</p>
                </div>
    ...
    <dialog id="delete_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box border-2 border-error shadow-xl">
            ...
            <div class="mb-6">
                <p class="text-gray-700 mb-2">Apakah Anda yakin ingin menghapus tipe tiket:</p>
                <div class="p-4 bg-error/5 border-l-4 border-error rounded-r">
                    <p class="font-bold text-gray-800" id="delete_ticket_name"></p>
                </div>
    ...
    <script>
        ...
        function openDeleteModal(id, name) {
            deleteId = id;
            document.getElementById('delete_ticket_name').textContent = name;
        ...
        function confirmDelete() {
            if (deleteId) {
                ...
                form.action = `/admin/ticket-types/${deleteId}`;
                form.submit();
            }
        }
