<x-layouts.admin title="Dashboard Admin">
    ...
    <div class="container mx-auto p-6 lg:p-10 animate-fade-in">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <!-- Total Event Card -->
            <div
                class="card bg-gradient-to-br from-blue-500 via-blue-600 to-blue-700 text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-scale-in border-0">
            ...
            <!-- Total Kategori Card -->
            <div class="card bg-gradient-to-br from-emerald-500 via-emerald-600 to-emerald-700 text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-scale-in border-0"
            ...
            <div class="card bg-gradient-to-br from-purple-500 via-purple-600 to-purple-700 text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-scale-in border-0"
            ...
            <!-- Total Revenue Card -->
            <div class="card bg-gradient-to-br from-amber-500 via-amber-600 to-amber-700 text-white shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 animate-scale-in border-0"
                ...
                <div class="card-body p-6">
                    ...
                    <div>
                        <h2 class="text-sm font-semibold opacity-90 uppercase tracking-wider mb-2">Total Pendapatan
                        </h2>
                ...
                @if (isset($recentOrders) && $recentOrders->count() > 0)
                    <div class="space-y-3 mt-6">
                        @foreach ($recentOrders as $order)
                            <div
                                class="group flex items-center justify-between p-5 bg-gradient-to-r from-gray-50 to-gray-50/50 hover:from-teal-50 hover:to-cyan-50 rounded-xl transition-all duration-300 border border-gray-100 hover:border-teal-200 hover:shadow-md">
                                <div class="flex items-center gap-4 flex-1">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        <p class="font-semibold text-gray-800 flex items-center gap-2">
                                            {{ $order->user->name }}
                                            <span
                                                class="badge badge-xs bg-teal-100 text-teal-700 border-teal-200">{{ $order->user->role }}</span>
                                        </p>
                                        <p class="text-sm text-gray-600 flex items-center gap-2 mt-1">
                                            ...
                                            <span class="truncate">Membeli tiket <span
                                                    class="font-medium">{{ $order->event->judul }}</span></span>
                                        </p>
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="text-right">
                                        <p
                                            class="font-bold text-lg bg-gradient-to-r from-teal-600 to-cyan-600 bg-clip-text">
                                            Rp {{ number_format($order->total_harga, 0, ',', '.') }}
                                        </p>
                                        <p class="text-xs text-gray-500">Total</p>
                                    </div>
                                    <a href="{{ route('admin.histories.show', $order->id) }}"
                                        class="btn btn-sm bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 border-0 shadow-sm hover:shadow-md transition-all">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
