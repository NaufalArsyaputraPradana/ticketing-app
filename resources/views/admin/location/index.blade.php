<x-layouts.admin title="Manajemen Lokasi">
    <div class="container mx-auto p-6 lg:p-10">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">Kelola lokasi yang tersedia</p>
            </div>
        ...
        <div class="overflow-x-auto rounded-xl bg-white shadow-lg">
            <div class="p-6 border-b border-gray-100">
                <h2 class="font-semibold text-gray-700">Daftar Lokasi</h2>
            </div>
                            ...
                            <td>
                                <div class="flex gap-2 justify-center">
                                    <button class="btn btn-sm btn-info gap-1" 
                                            onclick="openEditModal({{ $location->id }}, '{{ $location->name }}')">
                        ...
                        <tr>
                            <td colspan="3" class="text-center py-8">
                                <div class="text-gray-400">
                                    ...
                                    <p class="font-medium">Tidak ada lokasi tersedia</p>
                                    <p class="text-sm mt-1">Klik "Tambah Lokasi" untuk membuat lokasi baru</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
        ...
        <div class="modal-box max-w-md border-2 border-gray-200 shadow-xl">
            <form method="POST" action="{{ route('admin.locations.store') }}">
                ...
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-800">Tambah Lokasi</h3>
                    <p class="text-sm text-gray-500 mt-2">Masukkan nama lokasi baru</p>
                </div>
                <div class="form-control w-full mb-8">
                    <label class="label pb-2">
                        <span class="label-text font-semibold text-gray-700">
                            Nama Lokasi <span class="text-error">*</span>
                        </span>
                    </label>
                    <input type="text" 
                           placeholder="Contoh: Stadion Utama, Lapangan A, Venue X" 
    ...
    <dialog id="edit_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box max-w-md border-2 border-gray-200 shadow-xl">
            <form method="POST" id="edit_form">
                ...
                @method('PUT')
                <div class="mb-6 pb-4 border-b border-gray-200">
                    <h3 class="text-2xl font-bold text-gray-800">Edit Lokasi</h3>
                    <p class="text-sm text-gray-500 mt-2">Perbarui nama lokasi</p>
                </div>
                <div class="form-control w-full mb-8">
                    <label class="label pb-2">
                        <span class="label-text font-semibold text-gray-700">
    ...
    <dialog id="delete_modal" class="modal modal-bottom sm:modal-middle">
        <div class="modal-box border-2 border-error shadow-xl">
            ...
            <div class="mb-6">
                <p class="text-gray-700 mb-2">Apakah Anda yakin ingin menghapus lokasi:</p>
                <div class="p-4 bg-error/5 border-l-4 border-error rounded-r">
                    <p class="font-bold text-gray-800" id="delete_location_name"></p>
                </div>
    ...
    <script>
        ...
        function confirmDelete() {
            if (deleteId) {
                ...
                form.action = `/admin/locations/${deleteId}`;
                form.submit();
            }
        }
