<x-guest-layout>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-gray-500 text-sm">Tidak masalah! Masukkan email Anda dan kami akan mengirimkan link reset
            password.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
        ...
        <!-- Submit Button -->
        <button type="submit"
            class="btn w-full btn-lg gap-2 bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 border-0 shadow-md hover:shadow-lg transition-all">
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
