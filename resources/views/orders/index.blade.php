                                ...
                                <div class="card bg-base-100 shadow-xl border border-gray-200 hover:shadow-2xl transition-shadow">
                                    <div class="card-body">
                                        ...
                                        <div class="flex items-start justify-between mb-4">
                                            <div>
                                                ...
                                                <div class="flex items-center gap-2 mt-2">
                                                    ...
                                                    <span class="badge badge-ghost">{{ $order->order_date->locale('id')->translatedFormat('d F Y, H:i') }}</span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold">{{ $order->event->waktu->locale('id')->translatedFormat('d M Y') }}</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold">{{ $order->event->waktu->format('H:i') }} WIB</p>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="font-semibold truncate max-w-[200px]">{{ $order->event->lokasi }}</p>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bg-base-200 rounded-lg p-4">
                                            ...
                                            @foreach ($order->detailOrders as $detail)
                                                <div class="flex items-center justify-between py-2">
                                                    <div class="flex items-center gap-3">
                                                        <div class="badge badge-lg badge-primary">{{ ucfirst($detail->ticket->type) }}</div>
                                        ...
                                        <div class="card-actions justify-end mt-4">
                                            ...
                                            <a href="{{ route('events.show', $order->event->id) }}" class="btn btn-ghost">
                                                Info Event
                                            </a>
                                        </div>
                                    </div>
